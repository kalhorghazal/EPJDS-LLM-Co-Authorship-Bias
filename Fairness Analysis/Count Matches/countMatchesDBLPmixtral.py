...
df = df[["Scholar ID", "Name", "Country", "Ethnicity", "Gender", "h-index", "Co-authors’ names (DBLP)", "Co-authors’ names (Mixtral)", "Match Count 50%", "Match Count 60%", "Match Count 70%", "Match Count 80%", "Match Count 90%", "Match Count 100%"]]
df.head()

df.to_csv("matchDataDBLPmixtral.csv", index = False)