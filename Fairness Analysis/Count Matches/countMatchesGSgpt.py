...
df = df[["Scholar ID", "Name", "Country", "Ethnicity", "Gender", "h-index", "Co-authors’ names (Google Scholar)", "Co-authors’ names (GPT 3.5 Turbo)", "Match Count 50%", "Match Count 60%", "Match Count 70%", "Match Count 80%", "Match Count 90%", "Match Count 100%"]]
df.head()

df.to_csv("matchDataGSgpt.csv", index = False)