...
df = pd.read_csv("matchDataGSmixtral.csv")
df = df[df["h-index"] < 15]
df.columns
...
for index, row in df.iterrows():
  numCoAuthors = len(row["Co-authors’ names (Google Scholar)"].split("/"))
...
print("Ethnicity CDP 50%:", ethnicity_demographic_parity)
...
ethnicity_demographic_parity = minority_recall_mean / majority_recall_mean
print("Ethnicity CDP 60%:", ethnicity_demographic_parity)
...
ethnicity_demographic_parity = minority_recall_mean / majority_recall_mean
print("Ethnicity CDP 70%:", ethnicity_demographic_parity)
...
ethnicity_demographic_parity = minority_recall_mean / majority_recall_mean
print("Ethnicity CDP 80%:", ethnicity_demographic_parity)
...
ethnicity_demographic_parity = minority_recall_mean / majority_recall_mean
print("Ethnicity CDP 90%:", ethnicity_demographic_parity)
...
ethnicity_demographic_parity = minority_recall_mean / majority_recall_mean
print("Ethnicity CDP 100%:", ethnicity_demographic_parity)
